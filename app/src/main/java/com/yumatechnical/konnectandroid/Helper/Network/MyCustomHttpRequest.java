...
public class MyCustomHttpRequest extends Request {
	 ...
	 **/
	public MyCustomHttpRequest(int method, String url, Class responseClass, Response.Listener listener, Response.ErrorListener errorListener) {
